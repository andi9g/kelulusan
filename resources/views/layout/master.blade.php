...
<div class="wrapper">
  ...
  <aside class="main-sidebar text-dark  pinkku2 elevation-1">
    ...
    <a href="{{ url('/home', []) }}" class="brand-link pink-gelapku">
      ...
      <span class="brand-text text-bold text-white" style="font-size: 17px;letter-spacing: 2px">KELULUSAN</span>
    </a>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column nav-flat nav-legacy" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item hoverku">
              <a href="{{ url('kelulusan', []) }}" class="nav-link @yield('activekuKelulusan')">
